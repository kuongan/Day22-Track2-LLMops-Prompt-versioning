...
class PIIDetector(Validator):
    ...
    def validate(self, value: str, metadata: dict):
        ...
        if found_pii:
            ...
            return PassResult(fix_value=redacted_text)
        return PassResult(fix_value=value)
...
class JSONFormatter(Validator):
    ...
    @staticmethod
    def _repair(text: str) -> str:# type: ignore
        """
    ...
    def validate(self, value: str, metadata: dict):
        ...
        try:
            ...
            return PassResult(fix_value=repaired)
...
def demo_pii_guard():
    ...
    # Create the guard
    guard = Guard().use(PIIDetector(on_fail=OnFailAction.FIX))# type: ignore
...
def demo_json_guard():
    ...
    # Create the guard
    guard = Guard().use(JSONFormatter(on_fail=OnFailAction.FIX))# type: ignore
